...
|        | usage                                         |                 |             |              |        |
|--------+-----------------------------------------------+-----------------+-------------+--------------+--------|
|      2 | Resolve the issues of labs                    |                 | Apurv       | [2015-09-02] |        |
|--------+-----------------------------------------------+-----------------+-------------+--------------+--------|
|      3 | Finalize a good Java decompiler based on      |                 | Soujanya    | [2015-09-01] |        |
|        | features, price and community support etc     |                 | Avinash     |              |        |
|--------+-----------------------------------------------+-----------------+-------------+--------------+--------|
|      4 | Decompilation of .class files of two labs     | 3rd task        | Soujanya    | [2015-09-01] |        |
...
|--------+-----------------------------------------------+-----------------+-------------+--------------+--------|
|      5 | Update the Makefile with respect              | 4th task        | Sadhana     | [2015-09-01] |        |
|        | to decompiled .java code                      |                 | Sravanthi   |              |        |
|        |                                               |                 | Shriyansh   |              |        |
|--------+-----------------------------------------------+-----------------+-------------+--------------+--------|
|      6 | Cross check the sheet and correct             |                 | Khushpreet  | [2015-09-01] |        |
|        | the numbers                                   |                 |             |              |        |
|--------+-----------------------------------------------+-----------------+-------------+--------------+--------|
|      7 | To test new source code of Computer Graphics  |                 | Khushpreet  | [2015-09-01] |        |
|        | Lab                                           |                 |             |              |        |
|--------+-----------------------------------------------+-----------------+-------------+--------------+--------|
